...
-- ajout de 2 colonnes supplémentaires pour stocker les dimensions manquantes
-- on rend les champs obligatoires pour les futurs colis, on simule une valeur pour les enregistrements existants
