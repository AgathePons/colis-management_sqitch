...
-- pour les 2 dernières colonnes, on aurait pu ajouter le mot -clé NULL pour indiquer qu'on permet l'absence de valeur
-- toutefois, c'est le cas pas défaut, on n'est pas obligé d'indiquer cette info
